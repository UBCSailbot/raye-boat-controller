...
void convertFromBus(sailbot_msg::Sensors* msgPtr, SL_Bus_boat_controller_sailbot_msg_Sensors const* busPtr)
{
  ...
  msgPtr->gps_ais_latitude_degrees =  busPtr->GpsAisLatitudeDegrees;
  msgPtr->gps_ais_longitude_degrees =  busPtr->GpsAisLongitudeDegrees;
  ...
  msgPtr->gps_can_latitude_degrees =  busPtr->GpsCanLatitudeDegrees;
  msgPtr->gps_can_longitude_degrees =  busPtr->GpsCanLongitudeDegrees;
...
void convertToBus(SL_Bus_boat_controller_sailbot_msg_Sensors* busPtr, sailbot_msg::Sensors const* msgPtr)
{
  ...
  busPtr->GpsAisLatitudeDegrees =  msgPtr->gps_ais_latitude_degrees;
  busPtr->GpsAisLongitudeDegrees =  msgPtr->gps_ais_longitude_degrees;
  ...
  busPtr->GpsCanLatitudeDegrees =  msgPtr->gps_can_latitude_degrees;
  busPtr->GpsCanLongitudeDegrees =  msgPtr->gps_can_longitude_degrees;
